...
urlpatterns = [
    ...
    path('company/userStory/list/by/company/project/<company_name>/<project_name>/', UserStoryListByProjectNameAndCompanyNameView.as_view()),
    ...
    path('company/ticket/list/by/company/project/userStory/<company_name>/<project_name>/<user_story_display_id>/', TicketingListByCompanyAndProjectAndUserStorySubIdView.as_view()),
